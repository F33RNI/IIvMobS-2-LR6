...
> Все дальнейшие действия тестировались только на системе **Linux** и Python версии **3.7.17**
...
2. Установите Python версии **3.7**. Практическая работа была протестирована на Python версии **3.7.17**
...
14. Покажите для отчёта что модель обучилась и корректно распознаёт изображения. Для этого, скачайте любое изоюражение собаки и выполните следующие команды
    - На Linux
